...
#define CHIP_HEAP_END       (0x20000000 + 256*1024)//(NRF_HEAP_BEGIN + 5*1024)
...
#define CRITICAL_REGION_ENTER()   rt_enter_critical()
#define CRITICAL_REGION_EXIT()    rt_exit_critical()
